                        ...
                        <tbody>
                            ...
                            ?>
                                ...
                                <td><?php echo $bookingid; ?></td>
                                    ...
                                    <td><button type="submit" type="button" class="btn btn-outline-danger"><?php echo  "<a href='deleteBooking.php?id=" . $row['bookingID'] . "' >delete</a>"; ?></button>
<br><br><button name="update"  type="submit" onclick="" type="button" class="btn btn-outline-warning"><?php echo  "<a href='editBooking.php?id=" . $row['bookingID'] . "'>update</a>"; ?></button></td>
                                    <td></td>
                                </tr>
