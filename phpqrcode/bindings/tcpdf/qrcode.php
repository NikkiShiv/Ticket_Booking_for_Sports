...
// QR Code symbol is a VIP Seat barcode that can be scanned by
...
/**
 * Class to create QR-code arrays for TCPDF class.
 * QR Code symbol is a VIP Seat barcode that can be scanned by handy terminals such as a mobile phone with CCD.
